<template>
  <div>
    ...
    <el-table :data="points" stripe>
      ...
      <el-table-column label="变动" fixed width="60">
        <template slot-scope="scope">
          <span :class="scope.row.cssClazz">{{scope.row.typeDisplay}}</span>
        </template>
      </el-table-column>
      <el-table-column fixed label="变更" width="100">
        <template slot-scope="scope">
          <span :class="scope.row.cssClazz">{{scope.row.delta}}</span>
        </template>
      </el-table-column>
      <el-table-column prop="point" label="有效积分" width="100"></el-table-column>
      ...
      <el-table-column prop="expire" label="过期" width="100"></el-table-column>
